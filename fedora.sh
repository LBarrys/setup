...
RPMs="ghostty timeshift grub-btrfs-timeshift cloudflare-warp firefox thunderbird fastfetch vlc vlc-plugins-all Komikku telegram-desktop qbittorrent mission-center steam wine winetricks prismlauncher protonplus papirus-icon-theme bat wget p7zip p7zip-plugins unrar @virtualization"
