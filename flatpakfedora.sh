...
RPMs="ghostty timeshift grub-btrfs-timeshift cloudflare-warp firefox thunderbird fastfetch celluloid transmission-gtk steam wine winetricks mangohud java-latest-openjdk papirus-icon-theme bat wget p7zip p7zip-plugins unrar gnome-boxes"
Flatpaks="com.github.tchx84.Flatseal com.vysp3r.ProtonPlus com.mattjakeman.ExtensionManager io.github.realmazharhussain.GdmSettings org.prismlauncher.PrismLauncher io.github.radiolamp.mangojuice info.febvre.Komikku com.usebottles.bottles com.stremio.Stremio"
GNOME="gdm gnome-shell gnome-tweaks nautilus nautilus-open-any-terminal gnome-disk-utility gnome-text-editor gnome-weather gnome-shell-extension-appindicator gnome-shell-extension-blur-my-shell gnome-shell-extension-dash-to-dock gnome-shell-extension-just-perfection gnome-shell-extension-user-theme breeze-cursor-theme"
